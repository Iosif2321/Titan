...
FLAT не является 3м направлением. Это просто способ понимания что модель не может выдать UP/DOWN. FLAT считается нежелательным но
допустимым ответом, так как в реальном рынке нет такого состояния, цена всегда колеблется либо вверх, либо вниз, пусть и даже с
очень малой величеной. Можеди должны стремиться к прогнозированию во всем доступном для них диапазоне направления UP/DOWN, даже с
очень близкими значениями к пограничному FLAT.
